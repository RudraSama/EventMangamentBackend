...
const {createEvent, getEvents, getEvent, registerAttendie, unregisterAttendie, deleteEvent, editEvent} = require('../controllers/eventController');
...
router.put('/editEvent/:id', protect, upload.fields(multerMid), editEvent);
